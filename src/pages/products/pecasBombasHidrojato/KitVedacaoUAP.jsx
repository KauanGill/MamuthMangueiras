...
const KitVedacaoUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Kit de Vedação UAP', artist: 'Trifásico', cover: kitVedacaoUAP, color: '#FF5101' },
        { id: 2, title: 'Kit de Vedação UAP', artist: 'Vista lateral', cover: kitVedacaoUAP, color: '#FF5101' },
        { id: 3, title: 'Kit de Vedação UAP', artist: 'Detalhes', cover: kitVedacaoUAP, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Kit de Vedação UAP - Mamuth</title>
      </Helmet>
