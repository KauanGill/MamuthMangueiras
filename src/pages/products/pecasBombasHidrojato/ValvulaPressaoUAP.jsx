...
const ValvulaPressaoUAP = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Válvula Pressão UAP', artist: 'Trifásico', cover: valvulaPressaoUAP, color: '#FF5101' },
        { id: 2, title: 'Váuvula Pressão UAP', artist: 'Vista lateral', cover: valvulaPressaoUAP, color: '#FF5101' },
        { id: 3, title: 'Váuvula Pressão UAP', artist: 'Detalhes', cover: valvulaPressaoUAP, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Válvula Sucção UAP - Mamuth</title>
      </Helmet>
...
export default ValvulaPressaoUAP;