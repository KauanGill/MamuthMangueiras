...
const IntermediariaSAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Intermediária UAP', artist: 'Trifásico', cover: intermediariaSAP, color: '#FF5101' },
        { id: 2, title: 'Intermediária UAP', artist: 'Vista lateral', cover: intermediariaSAP, color: '#FF5101' },
        { id: 3, title: 'Intermediária UAP', artist: 'Detalhes', cover: intermediariaSAP, color: '#FF5101' }
  ];
