...
const SedeDuplaUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Sede Dupla UAP', artist: 'Trifásico', cover: sedeDuplaUAP, color: '#FF5101' },
        { id: 2, title: 'Sede Dupla UAP', artist: 'Vista lateral', cover: sedeDuplaUAP, color: '#FF5101' },
        { id: 3, title: 'Sede Dupla UAP', artist: 'Detalhes', cover: sedeDuplaUAP, color: '#FF5101' }
  ];
