...
const ValvulaSuccaoUAP = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Válvula Sucção UAP', artist: 'Trifásico', cover: valvulaSuccaoUAP, color: '#FF5101' },
        { id: 2, title: 'Válvula Sucção UAP', artist: 'Vista lateral', cover: valvulaSuccaoUAP, color: '#FF5101' },
        { id: 3, title: 'Válvula Sucção UAP', artist: 'Detalhes', cover: valvulaSuccaoUAP, color: '#FF5101' }
  ];
...
export default ValvulaSuccaoUAP;