...
const PistaoMetalDuroUAP = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Pistal de Metal Duro UAP', artist: 'Trifásico', cover: pistaoMetalUAP, color: '#FF5101' },
        { id: 2, title: 'Pistal de Metal Duro UAP', artist: 'Vista lateral', cover: pistaoMetalUAP, color: '#FF5101' },
        { id: 3, title: 'Pistal de Metal Duro UAP', artist: 'Detalhes', cover: pistaoMetalUAP, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Pistão de Metal Duro UAP - Mamuth</title>
      </Helmet>
...
export default PistaoMetalDuroUAP;