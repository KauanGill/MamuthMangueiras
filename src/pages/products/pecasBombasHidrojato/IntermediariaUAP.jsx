...
const IntermediariaUAP = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Intermediária UAP', artist: 'Trifásico', cover: intermediariaUAP, color: '#FF5101' },
        { id: 2, title: 'Intermediária UAP', artist: 'Vista lateral', cover: intermediariaUAP, color: '#FF5101' },
        { id: 3, title: 'Intermediária UAP', artist: 'Detalhes', cover: intermediariaUAP, color: '#FF5101' }
  ];
...
export default IntermediariaUAP;