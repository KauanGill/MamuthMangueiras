...
const CestoTampaoSAP = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Cesto Tampão SAP', artist: 'Trifásico', cover: cestoTampaoSAP, color: '#FF5101' },
        { id: 2, title: 'Cesto Tampão SAP', artist: 'Vista lateral', cover: cestoTampaoSAP, color: '#FF5101' },
        { id: 3, title: 'Cesto Tampão SAP', artist: 'Detalhes', cover: cestoTampaoSAP, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Cesto Tampão SAP - Mamuth</title>
      </Helmet>
