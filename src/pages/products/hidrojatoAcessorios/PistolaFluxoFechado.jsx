...
const PistolaFluxoFechado = () => {
  ...
  const slides = [
      ...
      { id: 2, title: 'Pistola Fluxo Fechado MTFF',  cover: pistolaFluxoFechadoMTFF, color: '#FF5101' },
      { id: 3, title: 'Pistola Fluxo Fechado MTFF',  cover: pistolaFluxoFechadoMTFF, color: '#FF5101' }
    ];
