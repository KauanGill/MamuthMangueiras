...
const PistolaFluxoFechado = () => {
  ...
  const slides = [
      { id: 1, title: 'Pistola Fluxo Fechado MTFF', artist: 'Trifásico', cover: pistolaFluxoFechadoMTFF, color: '#FF5101' },
      { id: 2, title: 'Pistola Fluxo Fechado MTFF', artist: 'Vista lateral', cover: pistolaFluxoFechadoMTFF, color: '#FF5101' },
      { id: 3, title: 'Pistola Fluxo Fechado MTFF', artist: 'Detalhes', cover: pistolaFluxoFechadoMTFF, color: '#FF5101' }
    ];
            ...
            <table className="w-full min-w-[1000px] border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-4 border-r border-gray-200 font-bold text-xl">Pistola MTFF 1200BAR</td>
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3,7</td>
