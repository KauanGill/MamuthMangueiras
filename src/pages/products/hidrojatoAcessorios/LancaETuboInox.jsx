...
const LancaTuboInox = () => {
  ...
  const slides = [
      { id: 1, title: 'Lança e Tubo Inox', artist: 'Trifásico', cover: lancaTuboinox, color: '#FF5101' },
      { id: 2, title: 'Lança e Tubo Inox', artist: 'Vista lateral', cover: lancaTuboinox, color: '#FF5101' },
      { id: 3, title: 'Lança e Tubo Inox', artist: 'Detalhes', cover: lancaTuboinox, color: '#FF5101' }
    ];
            ...
            <table className="w-full min-w-[1000px] border-collapse rounded-xl overflow-hidden shadow-md">
              <thead>
                <tr className="text-white" style={{ backgroundColor: '#FF6B0A' }}>
                  ...
                  <th className="py-6 px-4 border-r border-orange-400 font-bold text-lg">Opção de Rosca 1</th>
                  <th className="py-6 px-4 border-r border-orange-400 font-bold text-lg">Opção de Rosca 2</th>
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1/8</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">SOB MEDIDA</td>
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">M7 (Fêmea)</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">Mangueiras, Bicos, etc.</td>
                </tr>
              </tbody>
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1/4</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">SOB MEDIDA</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1.500</td>
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3/8</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">SOB MEDIDA</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">2.800</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3/8 UNF Esq (Macho)</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3/8 UNF Esq (Macho)</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">Mangueiras, Bicos, etc.</td>
                </tr>
              </tbody>
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">9/16</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">SOB MEDIDA</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3.200</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">9/16 UNF Esq (Macho)</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">9/16 UNF Esq (Macho)</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">Mangueiras, Bicos, etc.</td>
                </tr>
              </tbody>
