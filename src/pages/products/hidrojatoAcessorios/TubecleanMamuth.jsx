...
const TubeClean = () => {
  ...
  const slides = [
      { id: 1, title: 'Tubeclean Mamuth', artist: 'Trifásico', cover: tubecleanMamuth, color: '#FF5101' },
      { id: 2, title: 'Tubeclean Mamuth', artist: 'Vista lateral', cover: tubecleanMamuth, color: '#FF5101' },
      { id: 3, title: 'Tubeclean Mamuth', artist: 'Detalhes', cover: tubecleanMamuth, color: '#FF5101' }
    ];
