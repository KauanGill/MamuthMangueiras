...
const CabecoteRotativo3d = () => {
  ...
  const slides = [
      { id: 1, title: 'Cabeçote Rotativo 3D', artist: 'Trifásico', cover: cabecoteRotativo3D, color: '#FF5101' },
      { id: 2, title: 'Cabeçote Rotativo 3D', artist: 'Vista lateral', cover: cabecoteRotativo3D, color: '#FF5101' },
      { id: 3, title: 'Cabeçote Rotativo 3D', artist: 'Detalhes', cover: cabecoteRotativo3D, color: '#FF5101' }
    ];
