...
const PedalFluxoAberto = () => {
  ...
  const slides = [
      ...
      { id: 2, title: 'Pistola Fluxo Aberto MTFA',  cover: pedalFluxoAbertoMTPA, color: '#FF5101' },
      { id: 3, title: 'Pistola Fluxo Aberto MTFA',  cover: pedalFluxoAbertoMTPA, color: '#FF5101' }
    ];
