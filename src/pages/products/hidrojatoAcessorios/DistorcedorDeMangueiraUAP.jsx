...
const DistorcedorMangueiraUAP = () => {
  ...
  const slides = [
        { id: 1, title: 'Distorcedor de Mangueira UAP', artist: 'Trifásico', cover: distorcedorMangueiraUap, color: '#FF5101' },
        { id: 2, title: 'Distorcedor de Mangueira UAP', artist: 'Vista lateral', cover: distorcedorMangueiraUap, color: '#FF5101' },
        { id: 3, title: 'Distorcedor de Mangueira UAP', artist: 'Detalhes', cover: distorcedorMangueiraUap, color: '#FF5101' }
  ];
