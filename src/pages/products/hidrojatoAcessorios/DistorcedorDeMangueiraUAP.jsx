...
const DistorcedorMangueiraUAP = () => {
  ...
  const slides = [
        ...
        { id: 2, title: 'Distorcedor de Mangueira UAP',  cover: distorcedorMangueiraUap, color: '#FF5101' },
        { id: 3, title: 'Distorcedor de Mangueira UAP',  cover: distorcedorMangueiraUap, color: '#FF5101' }
  ];
