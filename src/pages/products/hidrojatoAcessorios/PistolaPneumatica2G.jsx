...
const PistolaPneumatica2G = () => {
  ...
  const slides = [
      { id: 1, title: 'Pistola Pneumática 2G MTPT', artist: 'Trifásico', cover: pistolaPneumatica2G, color: '#FF5101' },
      { id: 2, title: 'Pistola Pneumática 2G MTPT', artist: 'Vista lateral', cover: pistolaPneumatica2G, color: '#FF5101' },
      { id: 3, title: 'Pistola Pneumática 2G MTPT', artist: 'Detalhes', cover: pistolaPneumatica2G, color: '#FF5101' }
    ];
            ...
            <table className="w-full min-w-[1000px] border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-4 border-r border-gray-200 font-bold text-xl">Pistola MTPT 2800BAR - 2G</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1001.4006</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">2.800</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3,5</td>
