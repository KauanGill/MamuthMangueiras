...
const PistolaPneumatica2G = () => {
  ...
  const slides = [
      ...
      { id: 2, title: 'Pistola Pneumática 2G MTPT',  cover: pistolaPneumatica2G, color: '#FF5101' },
      { id: 3, title: 'Pistola Pneumática 2G MTPT',  cover: pistolaPneumatica2G, color: '#FF5101' }
    ];
