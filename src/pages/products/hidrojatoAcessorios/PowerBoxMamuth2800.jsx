...
const PowerBox2800 = () => {
  ...
  const slides = [
      { id: 1, title: 'Power Box MAMUTH 2.800', artist: 'Trifásico', cover: powerBoxMamuth, color: '#FF5101' },
      { id: 2, title: 'Power Box MAMUTH 2.800', artist: 'Vista lateral', cover: powerBoxMamuth, color: '#FF5101' },
      { id: 3, title: 'Power Box MAMUTH 2.800', artist: 'Detalhes', cover: powerBoxMamuth, color: '#FF5101' }
    ];
