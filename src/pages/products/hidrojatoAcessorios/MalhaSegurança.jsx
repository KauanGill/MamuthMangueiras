...
const MalhaDeSeguranca = () => {
  ...
  const slides = [
      { id: 1, title: 'Malha de Segurança', artist: 'Trifásico', cover: malhaSeguranca, color: '#FF5101' },
      { id: 2, title: 'Malha de Segurança', artist: 'Vista lateral', cover: malhaSeguranca, color: '#FF5101' },
      { id: 3, title: 'Malha de Segurança', artist: 'Detalhes', cover: malhaSeguranca, color: '#FF5101' }
    ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Malha de Segurança - Mamuth</title>
      </Helmet>
