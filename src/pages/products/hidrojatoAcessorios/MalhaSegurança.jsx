...
const MalhaDeSeguranca = () => {
  ...
  const slides = [
      { id: 1, title: 'Malha de Segurança',  cover: malhaSeguranca, color: '#FF5101' },
      { id: 2, title: 'Malha de Segurança',  cover: malhaSeguranca, color: '#FF5101' },
      { id: 3, title: 'Malha de Segurança',  cover: malhaSeguranca, color: '#FF5101' }
    ];
