            ...
            <table className="w-full min-w-[1000px] border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-4 border-r border-gray-200 font-bold text-xl">Pistola Rotativa Viper 40K</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1001.4008</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">2.800</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">5,6</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">3/4 UNF - 3/8-24 LH</td>
