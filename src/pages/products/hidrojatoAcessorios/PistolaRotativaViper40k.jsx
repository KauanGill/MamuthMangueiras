...
const PistolaRotativaViper40K = () => {
  ...
  const slides = [
      { id: 1, title: 'Pistola Rotativa Viper 40k', artist: 'Trifásico', cover: pistolaRotativaViper40k, color: '#FF5101' },
      { id: 2, title: 'Pistola Rotativa Viper 40k', artist: 'Vista lateral', cover: pistolaRotativaViper40k, color: '#FF5101' },
      { id: 3, title: 'Pistola Rotativa Viper 40k', artist: 'Detalhes', cover: pistolaRotativaViper40k, color: '#FF5101' }
    ];
            ...
            <table className="w-full border-collapse table-fixed bg-white">
              ...
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-2 border-r border-gray-200 text-sm md:text-lg text-center font-bold">Pistola Rotativa Viper 40K</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-sm md:text-lg text-center whitespace-nowrap">1001.4008</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-sm md:text-lg text-center">2.800</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-sm md:text-lg text-center">5,6</td>
...
export default PistolaRotativaViper40K;