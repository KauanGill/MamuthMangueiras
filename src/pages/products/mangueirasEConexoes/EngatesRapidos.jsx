...
const EngatesRapidos = () => {
  ...
  const slides = [
        ...
        { id: 2, title: 'Engates Rápidos',  cover: engatesRapidos, color: '#FF5101' },
        { id: 3, title: 'Engates Rápidos',  cover: engatesRapidos, color: '#FF5101' }
  ];
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl shadow-lg border-2 overflow-hidden transition-all duration-300" style={{ borderColor: '#FF6B0A' }}>
                <button 
                  ...
                  className="w-full flex justify-between items-center p-5 bg-white"
                >
                  <h3 className="font-bold text-lg text-[#0E0E68]">Luva</h3>
                  <span className="text-2xl text-[#FF6B0A] font-light">
                    {aberto === 't1' ? '−' : '+'}
                  </span>
                </button>
