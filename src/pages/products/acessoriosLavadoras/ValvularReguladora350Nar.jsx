...
const ValvulaReguladora350 = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Válvula Reguladora 350 bar', artist: 'Trifásico', cover: valvulaReguladora350bar, color: '#FF5101' },
        { id: 2, title: 'Válvula Reguladora 350 bar', artist: 'Vista lateral', cover: valvulaReguladora350bar, color: '#FF5101' },
        { id: 3, title: 'Válvula Reguladora 350 bar', artist: 'Detalhes', cover: valvulaReguladora350bar, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Válvula Reguladora 350 bar - Mamuth</title>
      </Helmet>
            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-6 px-1 border-r border-gray-200 font-bold text-[10px] sm:text-xs md:text-base text-center">VRT-100</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">350</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">5070</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">100</td>
...
export default ValvulaReguladora350;