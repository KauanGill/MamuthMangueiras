...
const ValvulaReguladora550 = () => {
  const navigate = useNavigate();
  const slides = [
        { id: 1, title: 'Distorcedor de Mangueira UAP', artist: 'Trifásico', cover: valvulaReguladora550bar, color: '#FF5101' },
        { id: 2, title: 'Distorcedor de Mangueira UAP', artist: 'Vista lateral', cover: valvulaReguladora550bar, color: '#FF5101' },
        { id: 3, title: 'Distorcedor de Mangueira UAP', artist: 'Detalhes', cover: valvulaReguladora550bar, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Válvula Reguladora 550 bar - Mamuth</title>
      </Helmet>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Válvula Reguladora 550 bar
          </h2>

          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            Válvula Reguladora de Pressão (By-Pass) com função de segurança.
          </p>
        </div>
      </section>
            ...
            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                ...
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-6 px-1 border-r border-gray-200 font-bold text-[10px] sm:text-xs md:text-base text-center">VB-53</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">550</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">8.000</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">80</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center whitespace-nowrap">1/2" BSP</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center whitespace-nowrap">1/2" BSP</td>
                  <td className="py-6 px-1 text-[10px] sm:text-xs md:text-base text-center leading-tight">Regulador de Pressão</td>
                </tr>
                {/* Segunda Linha (com leve destaque) */}
                <tr className="bg-gray-50 text-gray-800 border-b border-gray-200">
                  <td className="py-6 px-1 border-r border-gray-200 font-bold text-[10px] sm:text-xs md:text-base text-center">VB-53</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">550</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">7.975</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center">80</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center whitespace-nowrap">1/2" BSP</td>
                  <td className="py-6 px-1 border-r border-gray-200 text-[10px] sm:text-xs md:text-base text-center whitespace-nowrap">1/2" BSP</td>
                  <td className="py-6 px-1 text-[10px] sm:text-xs md:text-base text-center leading-tight">Regulador de Pressão</td>
...
export default ValvulaReguladora550;