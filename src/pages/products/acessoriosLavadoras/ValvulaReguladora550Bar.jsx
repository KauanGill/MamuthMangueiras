            ...
            <table className="w-full min-w-[1000px] border-collapse rounded-xl overflow-hidden shadow-md">
              ...
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-4 border-r border-gray-200 font-bold text-xl">VB-53</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">550</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">8.000</td>
                  ...
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1/2" BSP</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">Regulador de Pressão</td>
                </tr>
              </tbody>
              <tbody>
                <tr className="bg-white text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-4 border-r border-gray-200 font-bold text-xl">VB-53</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">550</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">7.975</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">80</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1/2" BSP</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">1/2" BSP</td>
                  <td className="py-8 px-4 border-r border-gray-200 text-xl">Regulador de Pressão</td>
