...
const Pistola350bar = () => {
  ...
  const slides = [
        ...
        { id: 2, title: 'Pistola 350 Bar', artist: 'Vista lateral', cover: pistola350bar, color: '#FF5101' },
        { id: 3, title: 'Pistola 350 Bar', artist: 'Detalhes', cover: pistola350bar, color: '#FF5101' }
  ];
