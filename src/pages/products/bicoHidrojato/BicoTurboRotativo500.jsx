...
// Import da imagem
import bicoTurboRotativo500 from '@/assets/images/bico-turbo-rotativo-600.jpg';

const BicoRotativo500 = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Bico Turbo Rotativo 500 - Mamuth</title>
      </Helmet>
...
export default BicoRotativo500;