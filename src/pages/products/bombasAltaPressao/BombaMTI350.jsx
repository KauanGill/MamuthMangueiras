...
const BombaMTI350 = () => {
  ...
  const slides = [
        { id: 1, title: 'Bomba MTI-350', artist: 'Trifásico', cover: bombaMTI350, color: '#FF5101' },
        { id: 2, title: 'Bomba MTI-350', artist: 'Vista lateral', cover: bombaMTI350, color: '#FF5101' },
        { id: 3, title: 'Bomba MTI-350', artist: 'Detalhes', cover: bombaMTI350, color: '#FF5101' }
  ];
