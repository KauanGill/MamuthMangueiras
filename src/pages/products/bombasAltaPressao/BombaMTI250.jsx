...
const BombaMTI250 = () => {
  ...
  const slides = [
        { id: 1, title: 'Bomba MTI-250', artist: 'Trifásico', cover: bombaMTI350, color: '#FF5101' },
        { id: 2, title: 'Bomba MTI-250', artist: 'Vista lateral', cover: bombaMTI350, color: '#FF5101' },
        { id: 3, title: 'Bomba MTI-250', artist: 'Detalhes', cover: bombaMTI350, color: '#FF5101' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Bomba MTI-250 - Mamuth</title>
      </Helmet>
            ...
            <table className="w-full border-collapse table-fixed bg-white">
              ...
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">MTI-250</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">250</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">17</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">12,5</td>
