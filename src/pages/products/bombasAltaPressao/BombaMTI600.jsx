...
const BombaMTI600 = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white w-full">
      <Helmet>
        <title>Bomba MTI-600 - Mamuth</title>
      </Helmet>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-10 text-left">
            Bomba Tríplex para hidrolavadoras ou testes hidrostaticos com pressão de 600 bar e vazão de até 35L/min.
          </p>
        </div>
      </section>
            ...
            <table className="w-full border-collapse table-fixed bg-white">
              ...
              <tbody>
                <tr className="text-gray-800 border-b border-gray-200">
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">MTI-600</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">600</td>
                  <td className="py-8 px-1 border-r border-gray-200 text-xs md:text-lg text-center whitespace-nowrap">35</td>
                  ...
                  <td className="py-8 px-1 text-xs md:text-lg text-center whitespace-nowrap">30</td>
                </tr>
              </tbody>
            </table>
          </div>
